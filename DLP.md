...
- [***Small custom dictionary detectors***](https://cloud.google.com/dlp/docs/concepts-infotypes#small) are simple word lists that Cloud DLP matches on and are preferred if you don't anticipate your word list changing significantly. Use small custom dictionary detectors when you have a list of up to ***several tens of thousands of words or phrases***.
...
- [Dotnet C# Github](https://github.com/GoogleCloudPlatform/dotnet-docs-samples/tree/master/dlp/api)  : Part of the Complete Dotnet Google API GitHub Project
#### Notes
