...
--CREATE ROLE ambari LOGIN ENCRYPTED PASSWORD 'dev';
...
GRANT ALL PRIVILEGES ON TABLE ambari.stack TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.clusters TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.clusterconfig TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.clusterconfigmapping TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.serviceconfig TO ambari;

CREATE TABLE ambari.serviceconfighosts (
  service_config_id BIGINT NOT NULL,
  host_id BIGINT NOT NULL,
  PRIMARY KEY(service_config_id, host_id));
GRANT ALL PRIVILEGES ON TABLE ambari.serviceconfighosts TO ambari;

CREATE TABLE ambari.serviceconfigmapping (
  service_config_id BIGINT NOT NULL,
  config_id BIGINT NOT NULL,
  PRIMARY KEY(service_config_id, config_id));
GRANT ALL PRIVILEGES ON TABLE ambari.serviceconfigmapping TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.clusterservices TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.clusterstate TO ambari;
...
CREATE TABLE ambari.cluster_version (
  ...
  PRIMARY KEY (id));
GRANT ALL PRIVILEGES ON TABLE ambari.cluster_version TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.hostcomponentdesiredstate TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.hostcomponentstate TO ambari;
...
CREATE TABLE ambari.hosts (
  ...
  PRIMARY KEY (host_id));
GRANT ALL PRIVILEGES ON TABLE ambari.hosts TO ambari;
...
CREATE TABLE ambari.hoststate (
  ...
  PRIMARY KEY (host_id));
GRANT ALL PRIVILEGES ON TABLE ambari.hoststate TO ambari;
...
CREATE TABLE ambari.host_version (
  ...
  state VARCHAR(32) NOT NULL,
  PRIMARY KEY (id));
GRANT ALL PRIVILEGES ON TABLE ambari.host_version TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.servicecomponentdesiredstate TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.servicedesiredstate TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.users TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.groups TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.members TO ambari;

CREATE TABLE ambari.execution_command (
  command BYTEA,
  task_id BIGINT NOT NULL,
  PRIMARY KEY (task_id));
GRANT ALL PRIVILEGES ON TABLE ambari.execution_command TO ambari;
...
CREATE TABLE ambari.host_role_command (
  ...
  PRIMARY KEY (task_id));
GRANT ALL PRIVILEGES ON TABLE ambari.host_role_command TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.role_success_criteria TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.stage TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.request TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.requestresourcefilter TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.requestoperationlevel TO ambari;

CREATE TABLE ambari.ClusterHostMapping (
  cluster_id BIGINT NOT NULL,
  host_id BIGINT NOT NULL,
  PRIMARY KEY (cluster_id, host_id));
GRANT ALL PRIVILEGES ON TABLE ambari.ClusterHostMapping TO ambari;

CREATE TABLE ambari.key_value_store (
  "key" VARCHAR(255),
  "value" VARCHAR,
  PRIMARY KEY ("key"));
GRANT ALL PRIVILEGES ON TABLE ambari.key_value_store TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.hostconfigmapping TO ambari;

CREATE TABLE ambari.metainfo (
  "metainfo_key" VARCHAR(255),
  "metainfo_value" VARCHAR,
  PRIMARY KEY ("metainfo_key"));
GRANT ALL PRIVILEGES ON TABLE ambari.metainfo TO ambari;

CREATE TABLE ambari.ambari_sequences (
  sequence_name VARCHAR(255) PRIMARY KEY,
  sequence_value BIGINT NOT NULL);
GRANT ALL PRIVILEGES ON TABLE ambari.ambari_sequences TO ambari;
...
CREATE TABLE ambari.configgroup (
  ...
  service_name VARCHAR(255),
  PRIMARY KEY(group_id));
GRANT ALL PRIVILEGES ON TABLE ambari.configgroup TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.confgroupclusterconfigmapping TO ambari;

CREATE TABLE ambari.configgrouphostmapping (
  config_group_id BIGINT NOT NULL,
  host_id BIGINT NOT NULL,
  PRIMARY KEY(config_group_id, host_id));
GRANT ALL PRIVILEGES ON TABLE ambari.configgrouphostmapping TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.requestschedule TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.requestschedulebatchrequest TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.blueprint TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.hostgroup TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.hostgroup_component TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.blueprint_configuration TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.hostgroup_configuration TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.viewmain TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.viewinstancedata TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.viewinstance TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.viewinstanceproperty TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.viewparameter TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.viewresource TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.viewentity TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.adminresourcetype TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.adminresource TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.adminprincipaltype TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.adminprincipal TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.adminpermission TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.adminprivilege TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.repo_version TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.artifact TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.widget TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.widget_layout TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.widget_layout_user_widget TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.topology_request TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.topology_hostgroup TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.topology_host_info TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.topology_logical_request TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.topology_host_request TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.topology_host_task TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.topology_logical_task TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.kerberos_principal TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.kerberos_principal_host TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.kerberos_descriptor TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.alert_definition TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_history TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_current TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_group TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_target TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_target_states TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_group_target TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_grouping TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.alert_notice TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.upgrade TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.upgrade_group TO ambari;
GRANT ALL PRIVILEGES ON TABLE ambari.upgrade_item TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_job_details TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_triggers TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_simple_triggers TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_cron_triggers TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_simprop_triggers TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_blob_triggers TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_calendars TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_paused_trigger_grps TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_fired_triggers TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_scheduler_state TO ambari;
...
GRANT ALL PRIVILEGES ON TABLE ambari.qrtz_locks TO ambari;
